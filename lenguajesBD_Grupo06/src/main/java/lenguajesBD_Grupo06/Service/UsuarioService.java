...
/**
 * Registro, verificacion de correo y asignacion de roles de aplicacion. Solo
 * usa JPA: aqui no hay procedimientos con COMMIT propio, por lo que los metodos
 * pueden ser transaccionales sin riesgo.
 */
@Service
public class UsuarioService {
     ...
     *
     * @return el token en claro que hay que enviar por correo. En la base solo
     * queda su hash.
     */
    @Transactional
    public String registrarCliente(String nombre, String apellido, String telefono,
        ...
        // TEMPORAL: sin envio de correo, la cuenta nace verificada.
// Volver a "N" cuando exista el CorreoService.
